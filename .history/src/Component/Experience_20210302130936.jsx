				...
				<div className="education">
					...
					<div className="educationSection">
						...
						<div className="educationRight">
							...
							<p className="font fontSty3">
								<b>GPA:</b> <em>Distinction</em> &nbsp; Artificial Intelligence (82), Data Warehouse and
					...
					<div className="educationSection">
						...
						<div className="educationRight">
							...
							<p className="font fontSty3">
              <b>GPA:</b> <em>Distinction</em> &nbsp; C++ Language Programming (91) Operating System (94) Multimedia Technology (95)
							</p>
						</div>
					</div>
				</div>
