...
function Professional(props) {
	return (
        ...
        <EachAbility name="Web Development" level="75" />
				<EachAbility name="Data Analysis" level="75" />
				<EachAbility name="Data Structure" level="65" />
				<EachAbility name="Machine Learning" level="45" />
			</section>
		</div>
	)
}
