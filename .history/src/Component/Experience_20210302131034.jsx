				...
				<div className="education">
					...
					<div className="educationSection">
						...
						<div className="educationRight">
							...
							<p className="font fontSty3">
								<b>GPA:</b> <em>Distinction</em></b> &nbsp; Artificial Intelligence (82), Data Warehouse and
					...
					<div className="educationSection">
						...
						<div className="educationRight">
							...
							<p className="font fontSty3">
								<b>GPA: <em>Distinction</em></b> &nbsp; C++ Language Programming (91), Operating System
								(94), Multimedia Technology (95)
							</p>
						</div>
					</div>
				</div>
