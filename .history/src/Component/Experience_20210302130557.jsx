				...
				<div className="education">
					...
					<div className="educationSection">
						...
						<div className="educationRight">
							...
							<p className="font fontSty3">
								<b>Relevant subject: Machine Learning, Neural Network, Data Analysis</b>
							</p>
							<p className="font fontSty3">
								<b>GPA:</b> <em>D</em> &nbsp; Artificial Intelligence (82) &nbsp; Data Warehouse and
								Data Mining (80) &nbsp; Information Technology (90)
							</p>
						</div>
					</div>
					<div className="educationSection">
						<div className="educationLeft">
							<p className="font fontSty4"> Bachelor of Science </p>
