export default [  
  {
    ...
    tag: ['ReactJS','Redux','contextAPI','Contentful']
  },
  {
  ...
  },
    {
      ...
      link2: 'https://github.com/Leooook/earthBnB',
      name: 'earthBnB',
      info: "EarthBnB is a lodging website which customers can browse all rooms' detail and sort rooms through different options.",
      extras: [
        "Customers can browse all rooms' detail.",
        'Customers can sort rooms by types, guests number, prices and other specific options.',
        'It is implemented in React library, while data is stored in JSON format and processed by Context API.'
      ],
      tag: ['ReactJS','contextAPI']
    }
