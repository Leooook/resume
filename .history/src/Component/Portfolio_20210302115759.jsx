...
function EachProject({ link, name, info, extras, tag }) {
	const handle = () => {
			...
			<div className="eachProject">
				...
				<div className="project">
					...
					<p className="font fontList">
						...
						<a className="fontLink" href={link} target="view_window">
							earthBnB
						</a>.
					</p>
					<div className="tags">
	...
	render() {
		return (
			<div id="portfolio" className="portfolio">
				<Title title="PORTFOLIO" num="02" info="THERE ARE MY LATEST PROJECT." />
