	...
	return (
		<div id="professional" className="professional">
			...
			<section className="professionalSection">
				...
				<EachAbility name="MongoDB" level="2" />
				...
				<EachAbility name="Web Development" level="3" type="type2" />
				<EachAbility name="Data Analysis" level="2" type="type2" />
				<EachAbility name="Data Structure" level="3" type="type2" />
				<EachAbility name="Machine Learning" level="2" type="type2" />
			</section>
		</div>
	)
}
